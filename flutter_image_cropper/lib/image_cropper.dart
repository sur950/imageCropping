...
class ImageCropper {
  ...
  static Future<File> cropImage({
    ...
    final String resultPath =
      ...
      'action_background_color': actionBackgroundColor?.value,
      'action_active_color': actionActiveColor?.value,
      'crop_frame_color': cropFrameColor?.value,
      'crop_grid_color': cropGridColor?.value,
      'active_widget_color': activeWidgetColor?.value,
      'dimmed_layer_color': dimmedLayerColor?.value,
